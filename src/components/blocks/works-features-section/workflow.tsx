            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant='ghost' size='sm'>
                  <img src={selectedModel.src} alt={selectedModel.name} className='size-4.5' loading='lazy' />
                ...
                {models.map(model => (
                  <DropdownMenuItem key={model.id} onClick={() => setSelectedModel(model)}>
                    <div className='flex items-center gap-2'>
                      <img src={model.src} alt={model.name} className='size-4.5' loading='lazy' />
        ...
        {showConnecting && !showExecutionSummary && (
          ...
          >
            {connectingItems.map((item, index) => (
              ...
              >
                <img src={item.image} alt={item.text} className='size-full max-h-3.5 max-w-3.5' loading='lazy' />
